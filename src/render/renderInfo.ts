 ...
 *
 * Ported from `RenderGrid/renderInfo.ts` nearly as-is. Pure computation: given a scroll
 ...
 * never called anywhere in Persephone. Removing them also removes a prototype mutation on a
 * hot object.
 */
