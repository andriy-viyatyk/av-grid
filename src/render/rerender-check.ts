 ...
 *
 * Ported from `RenderGrid/rerender-check.ts` as-is. Pure computation over plain objects; no
...
/**
 * Ascending inclusive range. Deliberately *not* the `range` in `core/utils.ts`: that one
